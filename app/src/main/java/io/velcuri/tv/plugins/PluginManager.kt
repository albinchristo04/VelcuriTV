...
import io.velcuri.tv.APIHolder.removePluginMapping
import io.velcuri.tv.AllLanguagesName
import io.velcuri.tv.AutoDownloadMode
...
import io.velcuri.tv.MainAPI.Companion.settingsForProvider
import io.velcuri.tv.MainActivity.Companion.afterPluginsLoadedEvent
import io.velcuri.tv.MainActivity.Companion.lastError
import io.velcuri.tv.PROVIDER_STATUS_DOWN
import io.velcuri.tv.PROVIDER_STATUS_OK
...
import io.velcuri.tv.mvvm.debugPrint
import io.velcuri.tv.mvvm.logError
import io.velcuri.tv.mvvm.safe
import io.velcuri.tv.plugins.RepositoryManager.ONLINE_PLUGINS_FOLDER
import io.velcuri.tv.plugins.RepositoryManager.PREBUILT_REPOSITORIES
import io.velcuri.tv.plugins.RepositoryManager.downloadPluginToFile
import io.velcuri.tv.plugins.RepositoryManager.getRepoPlugins
import io.velcuri.tv.plugins.RepositoryManager.sha256
import io.velcuri.tv.ui.settings.extensions.REPOSITORIES_KEY
import io.velcuri.tv.ui.settings.extensions.RepositoryData
