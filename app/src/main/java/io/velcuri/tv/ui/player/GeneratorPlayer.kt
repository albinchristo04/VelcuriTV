...
import io.velcuri.tv.CloudStreamApp
...
import io.velcuri.tv.LoadResponse.Companion.getImdbId
import io.velcuri.tv.LoadResponse.Companion.getMalId
import io.velcuri.tv.LoadResponse.Companion.getTMDbId
import io.velcuri.tv.MainActivity
import io.velcuri.tv.R
import io.velcuri.tv.TvType
import io.velcuri.tv.amap
import io.velcuri.tv.databinding.DialogOnlineSubtitlesBinding
import io.velcuri.tv.databinding.FragmentPlayerBinding
import io.velcuri.tv.databinding.PlayerSelectSourceAndSubsBinding
import io.velcuri.tv.databinding.PlayerSelectTracksBinding
import io.velcuri.tv.isAnimeOp
import io.velcuri.tv.isEpisodeBased
import io.velcuri.tv.isLiveStream
import io.velcuri.tv.isMovieType
...
import io.velcuri.tv.subtitles.AbstractSubtitleEntities
import io.velcuri.tv.subtitles.AbstractSubtitleEntities.SubtitleSearch
import io.velcuri.tv.syncproviders.AccountManager.Companion.subtitleProviders
import io.velcuri.tv.ui.download.DownloadButtonSetup
import io.velcuri.tv.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import io.velcuri.tv.ui.player.CustomDecoder.Companion.updateForcedEncoding
import io.velcuri.tv.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import io.velcuri.tv.ui.player.source_priority.LinkSource
...
import io.velcuri.tv.ui.result.ACTION_CLICK_DEFAULT
import io.velcuri.tv.ui.result.EpisodeAdapter
import io.velcuri.tv.ui.result.FOCUS_SELF
import io.velcuri.tv.ui.result.ResultEpisode
import io.velcuri.tv.ui.result.ResultFragment
...
import io.velcuri.tv.ui.result.setLinearListLayout
...
import io.velcuri.tv.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
import io.velcuri.tv.utils.AppContextUtils.getShortSeasonText
...
import io.velcuri.tv.utils.SubtitleHelper.fromTagToLanguageName
import io.velcuri.tv.utils.SubtitleHelper.languages
...
import io.velcuri.tv.utils.UIHelper.hideSystemUI
...
import io.velcuri.tv.utils.videoskip.VideoSkipStamp
