...
import io.velcuri.tv.MainActivity.Companion.afterPluginsLoadedEvent
import io.velcuri.tv.R
import io.velcuri.tv.Score
import io.velcuri.tv.SearchResponse
import io.velcuri.tv.base64Encode
import io.velcuri.tv.databinding.FragmentResultBinding
import io.velcuri.tv.databinding.FragmentResultSwipeBinding
import io.velcuri.tv.databinding.ResultRecommendationsBinding
import io.velcuri.tv.databinding.ResultSyncBinding
import io.velcuri.tv.databinding.TrailerCustomLayoutBinding
...
import io.velcuri.tv.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import io.velcuri.tv.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import io.velcuri.tv.ui.download.DownloadButtonSetup
import io.velcuri.tv.ui.player.CS3IPlayer
import io.velcuri.tv.ui.player.CSPlayerEvent
import io.velcuri.tv.ui.player.IPlayer
import io.velcuri.tv.ui.player.PlayerView
import io.velcuri.tv.ui.player.source_priority.QualityProfileDialog
import io.velcuri.tv.ui.quicksearch.QuickSearchFragment
import io.velcuri.tv.ui.result.ResultFragment.bindLogo
import io.velcuri.tv.ui.result.ResultFragment.getStoredData
import io.velcuri.tv.ui.result.ResultFragment.updateUIEvent
import io.velcuri.tv.ui.search.SearchAdapter
import io.velcuri.tv.ui.search.SearchHelper
import io.velcuri.tv.ui.setRecycledViewPool
import io.velcuri.tv.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import io.velcuri.tv.ui.settings.utils.getChooseFolderLauncher
...
import io.velcuri.tv.utils.AppContextUtils.openBrowser
...
import io.velcuri.tv.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import io.velcuri.tv.utils.SingleSelectionHelper.showBottomDialogInstant
import io.velcuri.tv.utils.SingleSelectionHelper.showDialog
...
import io.velcuri.tv.utils.UIHelper.popCurrentPage
import io.velcuri.tv.utils.UIHelper.populateChips
import io.velcuri.tv.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import io.velcuri.tv.utils.UIHelper.setListViewHeightBasedOnItems
import io.velcuri.tv.utils.UIHelper.setNavigationBarColorCompat
import io.velcuri.tv.utils.downloader.DownloadFileManagement.getBasePath
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: io.velcuri.tv.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        io.velcuri.tv.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        io.velcuri.tv.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
