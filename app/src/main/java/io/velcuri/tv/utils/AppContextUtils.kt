...
import io.velcuri.tv.MainActivity.Companion.afterRepositoryLoadedEvent
...
import io.velcuri.tv.plugins.RepositoryManager
...
import io.velcuri.tv.ui.WebviewFragment
import io.velcuri.tv.ui.player.SubtitleData
import io.velcuri.tv.ui.result.ResultFragment
import io.velcuri.tv.ui.settings.Globals
import io.velcuri.tv.ui.settings.extensions.PluginsFragment
...
import io.velcuri.tv.utils.FillerEpisodeCheck.toClassDir
import io.velcuri.tv.utils.JsUnpacker.Companion.load
...
//        hashSet.add("en") // def is only en
    ...
    fun Context.filterProviderByPreferredMedia(hasHomePageIsRequired: Boolean = true): List<MainAPI> {
        ...
        // java.lang.ClassCastException: io.velcuri.tv.TvType cannot be cast to io.velcuri.tv.TvType
