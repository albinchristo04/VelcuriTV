...
import io.velcuri.tv.services.PackageInstallerService
...
import io.velcuri.tv.utils.GitInfo.currentCommitHash
...
object InAppUpdater {
    ...
    private const val PRERELEASE_PACKAGE_NAME = "io.velcuri.tv.prerelease"
