...
import io.velcuri.tv.plugins.PLUGINS_KEY
import io.velcuri.tv.plugins.PLUGINS_KEY_LOCAL
import io.velcuri.tv.syncproviders.AccountManager
import io.velcuri.tv.syncproviders.providers.AniListApi.Companion.ANILIST_CACHED_LIST
import io.velcuri.tv.syncproviders.providers.MALApi.Companion.MAL_CACHED_LIST
import io.velcuri.tv.syncproviders.providers.KitsuApi.Companion.KITSU_CACHED_LIST
...
import io.velcuri.tv.utils.DataStore.getDefaultSharedPrefs
import io.velcuri.tv.utils.DataStore.getSharedPrefs
import io.velcuri.tv.utils.UIHelper.checkWrite
import io.velcuri.tv.utils.UIHelper.requestRW
import io.velcuri.tv.utils.downloader.VideoDownloadManager.setupStream
import io.velcuri.tv.utils.downloader.DownloadObjects
import io.velcuri.tv.utils.downloader.DownloadQueueManager.QUEUE_KEY
import io.velcuri.tv.utils.downloader.VideoDownloadManager.KEY_DOWNLOAD_INFO
import io.velcuri.tv.utils.downloader.VideoDownloadManager.KEY_RESUME_IN_QUEUE
import io.velcuri.tv.utils.downloader.VideoDownloadManager.KEY_RESUME_PACKAGES
...
object BackupUtils {
    ...
    /**
     * Copy of [io.velcuri.tv.utils.downloader.VideoDownloadManager.basePathToFile], [io.velcuri.tv.utils.downloader.VideoDownloadManager.getDefaultDir] and [io.velcuri.tv.utils.downloader.VideoDownloadManager.getBasePath]
