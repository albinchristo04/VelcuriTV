...
import com.velcuri.cobaltvpn.utils.AppUtils.toJsonLiteral
...
object DataStore {
    ...
    @Deprecated(
        "Please do not use the mapper version from DataStore. Preferably use methods from AppUtils " +
            ...
            "com.velcuri.cobaltvpn.mapper to access the mapper directly if necessary.",
        level = DeprecationLevel.ERROR,
        replaceWith = ReplaceWith("com.velcuri.cobaltvpn.mapper"),
    )
    val mapper = com.velcuri.cobaltvpn.mapper
