...
import com.velcuri.tv.ui.player.SubtitleOrigin
...
class CloudStreamPackage : OpenInAppAction(
    ...
    packageName = BuildConfig.APPLICATION_ID, //"com.velcuri.tv" or "com.velcuri.tv.prerelease"
    intentClass = "com.velcuri.tv.ui.player.DownloadedPlayerActivity"
) {
