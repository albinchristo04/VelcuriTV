...
import com.velcuri.tv.utils.AppUtils.toJsonLiteral
...
object DataStore {
    ...
    @Deprecated(
        "Please do not use the mapper version from DataStore. Preferably use methods from AppUtils " +
            ...
            "com.velcuri.tv.mapper to access the mapper directly if necessary.",
        level = DeprecationLevel.ERROR,
        replaceWith = ReplaceWith("com.velcuri.tv.mapper"),
    )
    val mapper = com.velcuri.tv.mapper
