...
import com.velcuri.tv.MainActivity.Companion.afterPluginsLoadedEvent
import com.velcuri.tv.R
import com.velcuri.tv.Score
import com.velcuri.tv.SearchResponse
import com.velcuri.tv.base64Encode
import com.velcuri.tv.databinding.FragmentResultBinding
import com.velcuri.tv.databinding.FragmentResultSwipeBinding
import com.velcuri.tv.databinding.ResultRecommendationsBinding
import com.velcuri.tv.databinding.ResultSyncBinding
import com.velcuri.tv.databinding.TrailerCustomLayoutBinding
...
import com.velcuri.tv.ui.BaseFragment
import com.velcuri.tv.ui.WatchType
import com.velcuri.tv.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.velcuri.tv.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.velcuri.tv.ui.download.DownloadButtonSetup
import com.velcuri.tv.ui.player.CS3IPlayer
import com.velcuri.tv.ui.player.CSPlayerEvent
import com.velcuri.tv.ui.player.IPlayer
import com.velcuri.tv.ui.player.PlayerView
import com.velcuri.tv.ui.player.source_priority.QualityProfileDialog
import com.velcuri.tv.ui.quicksearch.QuickSearchFragment
import com.velcuri.tv.ui.result.ResultFragment.bindLogo
import com.velcuri.tv.ui.result.ResultFragment.getStoredData
import com.velcuri.tv.ui.result.ResultFragment.updateUIEvent
import com.velcuri.tv.ui.search.SearchAdapter
import com.velcuri.tv.ui.search.SearchHelper
import com.velcuri.tv.ui.setRecycledViewPool
import com.velcuri.tv.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import com.velcuri.tv.ui.settings.utils.getChooseFolderLauncher
...
import com.velcuri.tv.utils.AppContextUtils.openBrowser
...
import com.velcuri.tv.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.velcuri.tv.utils.SingleSelectionHelper.showBottomDialogInstant
import com.velcuri.tv.utils.SingleSelectionHelper.showDialog
import com.velcuri.tv.utils.UIHelper.clipboardHelper
import com.velcuri.tv.utils.UIHelper.colorFromAttribute
...
import com.velcuri.tv.utils.UIHelper.popCurrentPage
import com.velcuri.tv.utils.UIHelper.populateChips
import com.velcuri.tv.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.velcuri.tv.utils.UIHelper.setListViewHeightBasedOnItems
import com.velcuri.tv.utils.UIHelper.setNavigationBarColorCompat
import com.velcuri.tv.utils.downloader.DownloadFileManagement.getBasePath
import com.velcuri.tv.utils.downloader.DownloadObjects
import com.velcuri.tv.utils.downloader.VideoDownloadManager
import com.velcuri.tv.utils.getImageFromDrawable
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.velcuri.tv.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.velcuri.tv.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.velcuri.tv.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
