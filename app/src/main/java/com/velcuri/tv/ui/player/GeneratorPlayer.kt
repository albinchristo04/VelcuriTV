...
import com.velcuri.tv.CloudStreamApp
...
import com.velcuri.tv.LoadResponse.Companion.getImdbId
import com.velcuri.tv.LoadResponse.Companion.getMalId
import com.velcuri.tv.LoadResponse.Companion.getTMDbId
import com.velcuri.tv.MainActivity
import com.velcuri.tv.R
import com.velcuri.tv.TvType
import com.velcuri.tv.amap
import com.velcuri.tv.databinding.DialogOnlineSubtitlesBinding
import com.velcuri.tv.databinding.FragmentPlayerBinding
import com.velcuri.tv.databinding.PlayerSelectSourceAndSubsBinding
import com.velcuri.tv.databinding.PlayerSelectTracksBinding
import com.velcuri.tv.isAnimeOp
import com.velcuri.tv.isEpisodeBased
import com.velcuri.tv.isLiveStream
import com.velcuri.tv.isMovieType
...
import com.velcuri.tv.subtitles.AbstractSubtitleEntities
import com.velcuri.tv.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.velcuri.tv.syncproviders.AccountManager.Companion.subtitleProviders
import com.velcuri.tv.ui.download.DownloadButtonSetup
import com.velcuri.tv.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import com.velcuri.tv.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.velcuri.tv.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.velcuri.tv.ui.player.source_priority.LinkSource
import com.velcuri.tv.ui.player.source_priority.QualityDataHelper
import com.velcuri.tv.ui.player.source_priority.QualityDataHelper.getLinkPriority
import com.velcuri.tv.ui.player.source_priority.QualityProfileDialog
import com.velcuri.tv.ui.result.ACTION_CLICK_DEFAULT
import com.velcuri.tv.ui.result.EpisodeAdapter
import com.velcuri.tv.ui.result.FOCUS_SELF
import com.velcuri.tv.ui.result.ResultEpisode
import com.velcuri.tv.ui.result.ResultFragment
...
import com.velcuri.tv.ui.result.setLinearListLayout
...
import com.velcuri.tv.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.velcuri.tv.ui.subtitles.SubtitlesFragment
import com.velcuri.tv.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
import com.velcuri.tv.utils.AppContextUtils.getShortSeasonText
...
import com.velcuri.tv.utils.SubtitleHelper.fromTagToEnglishLanguageName
import com.velcuri.tv.utils.SubtitleHelper.fromTagToLanguageName
import com.velcuri.tv.utils.SubtitleHelper.languages
...
import com.velcuri.tv.utils.UIHelper.hideSystemUI
import com.velcuri.tv.utils.UIHelper.popCurrentPage
import com.velcuri.tv.utils.UIHelper.toPx
import com.velcuri.tv.utils.downloader.DownloadUtils.getImageBitmapFromUrl
import com.velcuri.tv.utils.setText
import com.velcuri.tv.utils.txt
import com.velcuri.tv.utils.videoskip.VideoSkipStamp
