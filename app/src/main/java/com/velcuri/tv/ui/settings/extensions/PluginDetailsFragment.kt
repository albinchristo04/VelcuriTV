...
import com.velcuri.tv.databinding.FragmentPluginDetailsBinding
import com.velcuri.tv.plugins.PluginManager
import com.velcuri.tv.plugins.VotingApi.canVote
import com.velcuri.tv.plugins.VotingApi.getVotes
import com.velcuri.tv.plugins.VotingApi.hasVoted
import com.velcuri.tv.plugins.VotingApi.vote
import com.velcuri.tv.R
import com.velcuri.tv.ui.BaseBottomSheetDialogFragment
...
import com.velcuri.tv.utils.SubtitleHelper.getNameNextToFlagEmoji
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.velcuri.tv.plugins.Plugin
