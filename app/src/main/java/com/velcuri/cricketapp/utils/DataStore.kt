...
import com.velcuri.cricketapp.utils.AppUtils.toJsonLiteral
...
object DataStore {
    ...
    @Deprecated(
        "Please do not use the mapper version from DataStore. Preferably use methods from AppUtils " +
            ...
            "com.velcuri.cricketapp.mapper to access the mapper directly if necessary.",
        level = DeprecationLevel.ERROR,
        replaceWith = ReplaceWith("com.velcuri.cricketapp.mapper"),
    )
    val mapper = com.velcuri.cricketapp.mapper
