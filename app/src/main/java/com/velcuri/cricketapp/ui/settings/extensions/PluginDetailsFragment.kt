package com.velcuri.cricketapp.ui.settings.extensions
...
import com.velcuri.cricketapp.databinding.FragmentPluginDetailsBinding
import com.velcuri.cricketapp.plugins.PluginManager
import com.velcuri.cricketapp.plugins.VotingApi.canVote
import com.velcuri.cricketapp.plugins.VotingApi.getVotes
import com.velcuri.cricketapp.plugins.VotingApi.hasVoted
import com.velcuri.cricketapp.plugins.VotingApi.vote
import com.velcuri.cricketapp.R
import com.velcuri.cricketapp.ui.BaseBottomSheetDialogFragment
...
import com.velcuri.cricketapp.utils.SubtitleHelper.getNameNextToFlagEmoji
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.velcuri.cricketapp.plugins.Plugin
