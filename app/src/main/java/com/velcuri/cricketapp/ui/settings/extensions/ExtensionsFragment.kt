...
import com.velcuri.cricketapp.databinding.AddRepoInputBinding
import com.velcuri.cricketapp.databinding.FragmentExtensionsBinding
...
import com.velcuri.cricketapp.ui.settings.SettingsFragment.Companion.setSystemBarsPadding
...
import com.velcuri.cricketapp.utils.AppContextUtils.addRepositoryDialog
...
class ExtensionsFragment : BaseFragment<FragmentExtensionsBinding>(
    ...
    override fun onBindingCreated(binding: FragmentExtensionsBinding) {
        ...
        binding.apply {
            // Velcuri TV: hide add repo button - repos are built-in and non-modifiable
