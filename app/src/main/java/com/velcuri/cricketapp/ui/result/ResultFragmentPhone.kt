...
import com.velcuri.cricketapp.MainActivity.Companion.afterPluginsLoadedEvent
...
import com.velcuri.cricketapp.databinding.FragmentResultBinding
import com.velcuri.cricketapp.databinding.FragmentResultSwipeBinding
import com.velcuri.cricketapp.databinding.ResultRecommendationsBinding
import com.velcuri.cricketapp.databinding.ResultSyncBinding
import com.velcuri.cricketapp.databinding.TrailerCustomLayoutBinding
...
import com.velcuri.cricketapp.ui.BaseFragment
import com.velcuri.cricketapp.ui.WatchType
import com.velcuri.cricketapp.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.velcuri.cricketapp.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.velcuri.cricketapp.ui.download.DownloadButtonSetup
import com.velcuri.cricketapp.ui.player.CS3IPlayer
import com.velcuri.cricketapp.ui.player.CSPlayerEvent
import com.velcuri.cricketapp.ui.player.IPlayer
import com.velcuri.cricketapp.ui.player.PlayerView
import com.velcuri.cricketapp.ui.player.source_priority.QualityProfileDialog
import com.velcuri.cricketapp.ui.quicksearch.QuickSearchFragment
import com.velcuri.cricketapp.ui.result.ResultFragment.bindLogo
import com.velcuri.cricketapp.ui.result.ResultFragment.getStoredData
import com.velcuri.cricketapp.ui.result.ResultFragment.updateUIEvent
import com.velcuri.cricketapp.ui.search.SearchAdapter
import com.velcuri.cricketapp.ui.search.SearchHelper
import com.velcuri.cricketapp.ui.setRecycledViewPool
import com.velcuri.cricketapp.ui.settings.SettingsGeneral.Companion.pickDownloadPath
import com.velcuri.cricketapp.ui.settings.utils.getChooseFolderLauncher
...
import com.velcuri.cricketapp.utils.AppContextUtils.openBrowser
...
import com.velcuri.cricketapp.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.velcuri.cricketapp.utils.SingleSelectionHelper.showBottomDialogInstant
import com.velcuri.cricketapp.utils.SingleSelectionHelper.showDialog
import com.velcuri.cricketapp.utils.UIHelper.clipboardHelper
import com.velcuri.cricketapp.utils.UIHelper.colorFromAttribute
...
import com.velcuri.cricketapp.utils.UIHelper.popCurrentPage
import com.velcuri.cricketapp.utils.UIHelper.populateChips
import com.velcuri.cricketapp.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.velcuri.cricketapp.utils.UIHelper.setListViewHeightBasedOnItems
import com.velcuri.cricketapp.utils.UIHelper.setNavigationBarColorCompat
import com.velcuri.cricketapp.utils.downloader.DownloadFileManagement.getBasePath
import com.velcuri.cricketapp.utils.downloader.DownloadObjects
import com.velcuri.cricketapp.utils.downloader.VideoDownloadManager
import com.velcuri.cricketapp.utils.getImageFromDrawable
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.velcuri.cricketapp.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.velcuri.cricketapp.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.velcuri.cricketapp.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
